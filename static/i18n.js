...
const TRANSLATIONS = {
  ...
  vi: {
    ...
    settings_runtime_manage: 'Quản lý runtime…',
    settings_runtime_desc:   'Chọn Bundled Core, một bản cài SmartDocs WebApp có sẵn, hoặc một máy chủ từ xa. Việc thay đổi sẽ khởi động lại backend.',
    ...
    // Settings — AI models (Model Registry / Router)
    settings_models_title:  '🧠 Mô hình AI',
    settings_models_desc:   '“Cục bộ” chạy trên máy này, “Tự lưu trữ” là máy chủ tương thích OpenAI của riêng bạn (máy này, mạng LAN hoặc máy chủ riêng), còn “Đám mây” gửi câu lệnh đến nhà cung cấp bên thứ ba. Mô hình cục bộ đi kèm luôn là phương án dự phòng ngoại tuyến.',
    models_routing_title:   'Định tuyến theo tác vụ',
    models_task_chat:       'Chat / Hỏi đáp tài liệu',
    models_task_summarize:  'Tóm tắt',
    models_task_rewrite:    'AI viết lại',
    models_task_agent:      'Agent',
    models_fallback:        'Mô hình dự phòng',
    models_auto:            'Tự động (hành vi hiện tại)',
    models_none:            'Không',
    models_save:            'Lưu định tuyến',
    models_routing_saved:   'Đã lưu định tuyến.',
    models_state_ready:     'Sẵn sàng (đã nạp)',
    models_state_loading:   'Đang nạp…',
    models_state_installed: 'Đã cài đặt',
    models_state_unavailable: 'Không khả dụng',
    models_state_failed:    'Lỗi',
    models_local_label:     'Cục bộ',
    models_self_hosted_label: 'Tự lưu trữ',
    models_cloud_label:     'Đám mây',
    models_self_hosted_title: 'Máy chủ tự lưu trữ tương thích OpenAI',
    models_save_server:     'Lưu máy chủ',
    models_test:            'Kiểm tra kết nối',
    models_server_saved:    'Đã lưu máy chủ.',
    models_state_connected: 'Đã kết nối',
    models_state_sh_unavailable: 'Không thể kết nối',
    models_state_incompatible: 'Không tương thích',
    models_state_auth_failed: 'Xác thực thất bại',
    models_state_model_not_found: 'Không tìm thấy mô hình',
    models_state_context:   'Ngữ cảnh không đủ',
    models_insecure_lan:    'Cho phép HTTP không mã hoá trên mạng LAN riêng (chỉ 10.x / 172.16–31.x / 192.168.x — dữ liệu không được mã hoá; localhost không cần tuỳ chọn này)',
    models_insecure_active: 'HTTP không mã hoá (LAN không an toàn)',
    models_insecure_cancelled: 'Đã huỷ — chưa lưu gì.',
    models_env_locked:      'Máy chủ này được cấu hình từ .env (OPENAI_COMPATIBLE_*) nên không thể sửa tại đây.',
    models_sh_key_hint:     'Nếu máy chủ cần khóa API, hãy lưu ở mục “Máy chủ tự lưu trữ” bên dưới — khóa được giữ trong kho thông tin xác thực của hệ điều hành.',
    models_managed_title:   'Nhập mô hình cục bộ',
    models_managed_desc:    'Trỏ tới thư mục mô hình Hugging Face đã có trên đĩa — trọng số giữ nguyên tại chỗ, chỉ nạp khi dùng và có thể giải phóng để tiết kiệm bộ nhớ.',
    models_import:          'Nhập',
    models_imported:        'Đã nhập mô hình.',
    models_import_need_path: 'Hãy nhập đường dẫn thư mục mô hình.',
    models_unload:          'Giải phóng',
    models_unloaded:        'Đã giải phóng mô hình.',
    models_remove:          'Xóa',
    models_removed:         'Đã xóa mô hình.',
    models_remove_confirm:  'Xóa mô hình này khỏi danh sách? Tệp trên đĩa không bị xoá.',
    models_load_failed:     'Không thể tải danh sách mô hình.',
  ...
  en: {
    ...
    // Settings — backend runtime panel (desktop shell only)
    settings_runtime_title:  '🖥 Backend runtime',
    settings_runtime_manage: 'Manage backend runtime…',
    settings_runtime_desc:   'Choose the Bundled Core, an existing SmartDocs WebApp installation, or a remote server. Changing the runtime restarts the backend.',
    ...
    // Settings — AI models (Model Registry / Router)
    settings_models_title:  '🧠 AI models',
    settings_models_desc:   '“Local” runs on this machine, “Self-hosted” is your own OpenAI-compatible server (this machine, LAN, or a private server), and “Cloud” sends prompts to a third-party provider. The bundled local model always remains the offline fallback.',
    models_routing_title:   'Task routing',
    models_task_chat:       'Chat / Document QA',
    models_task_summarize:  'Summarization',
    models_task_rewrite:    'AI Rewrite',
    models_task_agent:      'Agent',
    models_fallback:        'Fallback model',
    models_auto:            'Automatic (current behavior)',
    models_none:            'None',
    models_save:            'Save routing',
    models_routing_saved:   'Routing saved.',
    models_state_ready:     'Ready (loaded)',
    models_state_loading:   'Loading…',
    models_state_installed: 'Installed',
    models_state_unavailable: 'Unavailable',
    models_state_failed:    'Failed',
    models_local_label:     'Local',
    models_self_hosted_label: 'Self-hosted',
    models_cloud_label:     'Cloud',
    models_self_hosted_title: 'Self-hosted OpenAI-compatible server',
    models_save_server:     'Save server',
    models_test:            'Test connection',
    models_server_saved:    'Server saved.',
    models_state_connected: 'Connected',
    models_state_sh_unavailable: 'Unavailable',
    models_state_incompatible: 'Incompatible',
    models_state_auth_failed: 'Authentication failed',
    models_state_model_not_found: 'Model not found',
    models_state_context:   'Context insufficient',
    models_insecure_lan:    'Allow insecure HTTP on private LAN (10.x / 172.16–31.x / 192.168.x only — traffic is unencrypted; localhost never needs this)',
    models_insecure_active: 'unencrypted HTTP (insecure LAN)',
    models_insecure_cancelled: 'Cancelled — nothing was saved.',
    models_env_locked:      'This server is configured from .env (OPENAI_COMPATIBLE_*) and cannot be edited here.',
    models_sh_key_hint:     'If the server needs an API key, save it below under “Self-hosted server” — it is kept in the OS credential store.',
    models_managed_title:   'Import a local model',
    models_managed_desc:    'Points at a Hugging Face model folder already on disk — weights stay where they are, load only when used, and can be unloaded to free memory.',
    models_import:          'Import',
    models_imported:        'Model imported.',
    models_import_need_path: 'Enter the model folder path.',
    models_unload:          'Unload',
    models_unloaded:        'Model unloaded.',
    models_remove:          'Remove',
    models_removed:         'Model removed.',
    models_remove_confirm:  'Remove this model from the list? Files on disk are not deleted.',
    models_load_failed:     'Could not load the model list.',
