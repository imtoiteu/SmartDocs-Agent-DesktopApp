...
const TRANSLATIONS = {
  ...
  vi: {
    ...
    models_sh_desc:         'Dùng máy chủ mô hình bạn tự vận hành — llama.cpp, vLLM, Ollama, LM Studio… — trên máy này, máy GPU trong LAN hoặc máy chủ riêng. Ứng dụng chỉ gửi yêu cầu tới đó; không cần cài mô hình trên máy này.',
    models_sh_url_label:    'Địa chỉ máy chủ (Base URL)',
    models_sh_model_label:  'Tên mô hình',
    models_sh_key_label:    'Khóa API (tuỳ chọn — giữ trong kho thông tin xác thực của hệ điều hành, không lưu vào tệp)',
    models_sh_ctx_label:    'Ngữ cảnh (token)',
    models_sh_timeout_label: 'Thời gian chờ (giây)',
    models_sh_key_none:     'Chưa lưu khóa',
    models_sh_key_remove:   'Xóa khóa',
    models_sh_key_removed:  'Đã xóa khóa khỏi kho thông tin xác thực.',
    models_sh_clear:        'Xóa / tắt',
    models_sh_clear_confirm: 'Tắt máy chủ tự lưu trữ? Các tác vụ đang định tuyến tới nó sẽ trở về Tự động; khóa API vẫn được giữ trong kho thông tin xác thực.',
    models_sh_cleared:      'Đã tắt máy chủ tự lưu trữ.',
    models_routes_reset:    'Định tuyến trở về Tự động:',
    models_state_timeout:   'Hết thời gian chờ',
    models_state_policy_blocked: 'Bị chặn bởi chính sách bảo mật URL',
    models_configure:       'Cấu hình…',
  ...
  en: {
    ...
    models_sh_desc:         'Use a model server you run yourself — llama.cpp, vLLM, Ollama, LM Studio… — on this machine, a LAN GPU box, or a private server. This app only sends requests to it; the model does not need to be installed here.',
    models_sh_url_label:    'Base URL',
    models_sh_model_label:  'Model name',
    models_sh_key_label:    'API key (optional — kept in the OS credential store, never in files)',
    models_sh_ctx_label:    'Context (tokens)',
    models_sh_timeout_label: 'Timeout (s)',
    models_sh_key_none:     'No key stored',
    models_sh_key_remove:   'Remove key',
    models_sh_key_removed:  'Key removed from the credential store.',
    models_sh_clear:        'Clear / disable',
    models_sh_clear_confirm: 'Disable the self-hosted server? Tasks routed to it go back to Automatic; the saved API key is kept in the credential store.',
    models_sh_cleared:      'Self-hosted server disabled.',
    models_routes_reset:    'Routes reset to Automatic:',
    models_state_timeout:   'Timeout',
    models_state_policy_blocked: 'Blocked by URL security policy',
    models_configure:       'Configure…',
